(function(b) {
	...
	b.fn.cleanHtml = function() {
		var c = b(this).html();
		return c && c.replace(/(<br>|\s|<textarea[name=description]><div><br><\/div><\/textarea>|&nbsp;)*$/, "")
	};
	b.fn.wysiwyg = function(k) {
		var l = this, h, q, d, p = function() {
			...
			s.find("input[type=text][data-" + r.commandRole + "]").on(
					"webkitspeechchange change", function() {
						var t = this.value;
						this.value = "";
						e();
						if (t) {
			...
			s.find("input[type=file][data-" + r.commandRole + "]").change(
					function() {
						e();
		...
		d = "a[data-" + q.commandRole + "],button[data-" + q.commandRole
		...
		b(window)
				.bind(
						"touchend",
						function(u) {
							var t = (l.is(u.target) || l.has(u.target).length > 0), s = g(), r = s
