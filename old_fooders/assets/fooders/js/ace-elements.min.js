...
(function(e, c) {
	...
	f.prototype.apply_settings = function() {
		...
		this.$element.after('<label data-title="'
	...
	f.prototype.show_file_list = function(k) {
		...
		for ( var p = 0; p < n.length; p++) {
			...
			if (!this.well_style) {
				...
				this.$label.append('<span data-title="' + l + '"><i class="'
						+ m + '"></i></span>');
	...
	a.fn.ace_wysiwyg = function(c, h) {
		...
		this
				.each(function() {
						...
						if (f.hasOwnProperty(m)) {
							...
							case "createLink":
								q += ' <a class="btn btn-small '
										+ p
										+ ' dropdown-toggle" data-toggle="dropdown" title="'
										+ o.title + '"><i class="' + o.icon
										+ '"></i></a> ';
								q += ' <div class="dropdown-menu dropdown-caret input-append pull-right">							<input placeholder="'
										+ o.placeholder
										+ '" type="text" data-edit="'
										+ o.name
							...
							case "insertImage":
								...
								if ("FileReader" in window) {
									q += '<div class="center">								<button class="btn btn-small btn-success wysiwyg-choose-file" type="button">'
											+ o.button_text
							...
							case "foreColor":
							case "backColor":
								q += ' <select class="hide wysiwyg_colorpicker" title="'
										+ o.title + '"> ';
								for ( var l in o.values) {
									q += ' <option value="' + o.values[l]
											+ '">' + o.values[l] + "</option> "
								}
								q += " </select> ";
								q += ' <input style="display:none;" disabled class="hide" type="text" data-edit="'
										+ o.name + '" /> ';
								break;
							default:
								q += ' <a class="btn btn-small ' + p
										+ '" data-edit="' + o.name
										+ '" title="' + o.title
										+ '"><i class="' + o.icon
										+ '"></i></a> ';
					...
					q.find(".dropdown-menu input:not([type=file])").on(
					...
					q.find(".wysiwyg_colorpicker").each(
							function() {
