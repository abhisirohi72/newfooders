			...
			<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'];?>"
                  ...
                  <div class="control-group">
												...
												<div class="radio">
													<label>
														<input name="discount_type" type="radio" class="discountType" value="0" <?php if(isset($edit_id) && $get_coupon['discount_type']=='0') echo 'checked'; else echo 'checked';  ?>>
														<span class="lbl"> Amount</span>
													</label>
												</div>
                                        	<div class="radio">
													<label>
														<input name="discount_type" type="radio" class="discountType" value="1" <?php if(isset($edit_id) && $get_coupon['discount_type']=='1') echo 'checked'; elseif($discount_type=='1') echo 'checked';  ?>>
                                            ...
                                            <div class="controls">
                                                <input autocomplete="off" type="text" class="amountPercent" name="amount" value="<?php if(isset($edit_id)) echo $get_coupon['amount']; else echo $amount; ?>" /> 
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label grey" for="form-field-6">Minimum order amount <font class="red">*</font></label>
                                            <div class="controls">
                                                <input autocomplete="off" type="text" name="minimum_order_amount" id="minOrderAmt" value="<?php if(isset($edit_id)) echo $get_coupon['minimum_order_amount']; else echo $minimum_order_amount; ?>" /> 
                                            </div>
                                        </div>
                 </div>
                  </div>
