					...
					<div class="login-container">
						...
						<div class="row-fluid">
							<div class="center">
								<h1>
									<img alt="logo"
										src="<?php echo SITE_URL.'/assets/fooders/img/fooder_login.png';?>">
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header red lighter bigger">
												<i class="icon-key"></i> <?php echo frprp;?>
											</h4>
                                            <?php
                                            echo "<center><h2>".$display_reset."</h2></center>";
											//if($isTokenCorrect && $expire_time<120 && $hashedTokenFromDatabase['used']==='1')
                                            if($isTokenCorrect && $hashedTokenFromDatabase['used']==='1')
                                            {
                                            	echo $display_reset_form;
                                            ?>
											<div class="space-6"></div>
											<p><?php echo frpeynp;?></p>
											...
											<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
												...
												<fieldset>
													<label> <span class="block input-icon input-icon-right"> <input
															autocomplete="off" name="new_pass" type="password"
															 autofocus class="span12"
															placeholder="<?php echo frpnp;?>" /> <i class="icon-lock"></i>
													</span>
													</label>
													<label> <span class="block input-icon input-icon-right"> <input
															autocomplete="off" name="retype_pass" type="password"
															  class="span12"
															placeholder="<?php echo frprnp;?>" /> <i class="icon-lock"></i>
													</span>
													</label>
													...
													<div class="clearfix">
														<button
															...
															name="save_reset_pass" type="submit">
															<i class="icon-key"></i> <?php echo frpbs;?>
														</button>
													</div>
												</fieldset>
											</form>
										...
										<div class="toolbar center">
											<a href="<?php echo $link->link('login',fooders);?>"
												...
												class="icon-arrow-left"></i> <?php echo frpbtl;?> 
											</a>
										</div>
									</div>
									<!--/widget-body-->
