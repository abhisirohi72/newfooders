      ...
      <div class="osahan-cart-item-profile-body">
            ...
            <div class="mb-3 shadow bg-white p-3 py-3 mt-3 clearfix">
               <div class="input-group-sm mb-2 input-group">
                  <input placeholder="Enter promo code" type="text" class="form-control promoCode">
                 <input type="hidden" id="grandamt" value="<?php echo $feature->encrypt_decrypt('encrypt',$pricep); ?>">
                  ...
                  <div class="input-group-append"><button id="button-addon2" onclick="applyPromo(this,event,'<?php echo $_REQUEST['fid']; ?>');" type="button" class="btn btn-primary">APPLY</button></div>
               </div>
               <div class="mb-0">
