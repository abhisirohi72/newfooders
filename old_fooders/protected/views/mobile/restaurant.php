         ...
         <div class="osahan-restaurant-detail">
            <div class="p-3 osahan-inner-header bg-primary">
               <div class="d-flex align-items-center">
                  ...
                  <div class="ml-auto d-flex align-items-center">
                     ...
                     <!-- <a class="text-white mx-2 fs-18 top-nav-btn-cart position-relative" data-toggle="modal" data-target="#exampleModal" href="#"><i class="feather-filter"></i></a> -->
                     <a class="text-white mx-2 fs-18 top-nav-btn-cart position-relative" data-toggle="modal" onclick="cusineFilter(this,event,'<?php echo $_REQUEST['id']; ?>')" href="#"><i class="feather-filter"></i></a>
            ...
            <div class="px-3 pt-4 pb-3 bg-primary">
             ...
             <div>
                  ...
                  <?php 
                 /* if(isset($_SESSION['tableno']) && $_SESSION['tableno']!=''){ 
                     ?> 
                      <button class="callwaiterbtn" style="display:none;" onclick="callWaiter(event,this,'<?php echo $_REQUEST['tableno']; ?>','<?php echo $_REQUEST['id']; ?>');">Call Waiter</button>
                      <button class="callwaiterbtn" onclick="getLocation()">Call Waiter</button>
                  <?php } */?>
            ...
            <div class="row">
                     <div class="col-6">
                     <button class="callwaiterbtn bg-warning" style="font-size:15px!important;" onclick="callWaiter(event,this,'<?php echo $_SESSION['tableno']; ?>','<?php echo $_REQUEST['id']; ?>');">Call Waiter</button>
                        <!-- <p class="m-0 text-white"><span class="badge badge-osahan badge-warning">Call Waiter</span></p> -->
                     </div>
                     <div class="col-6 text-right">
                        <p class="m-0 text-white">Table No  <span class="badge badge-osahan badge-dark" style="font-size:25px!important;"><?php echo $_SESSION['tableno']; ?></span></p>
                     </div>
                  </div>
            <?php }else{ ?>              
                  <div class="row">
            ...
            <div class="px-3 pt-3 stickybox">
               ...
               <div class="input-group-prepend" id="searchClose" style="display:none;">
                  <button class="border-0 btn btn-outline-secondary text-primary bg-white btn-block"><i class="feather-x"></i></button>
               </div>
            </div>
        </div>
        <!-- btnactive -->
            <div class="px-3 pt-3 vegblock">
               <?php //if($checkveg=='1'){ 
                  //echo "<pre>",print_r($_SESSION),"</pre>";
                  ?>
               <div class="vegchk vegdiv">
                  <label>
                     <input type="checkbox" id="vegDish" value="0"><span><img src="<?php echo SITE_URL.'/assets/mobile/';?>img/veg.png" alt="#" class="type"> Veg</span>
                  </label>
               </div>
               <?php //}
               //if($checknonveg=='1'){
               ...
               <div class="vegchk vegdiv">
                  <label>
                     <input type="checkbox" id="nonVegDish" value="1"><span><img src="<?php echo SITE_URL.'/assets/mobile/';?>img/nonveg.png" alt="#" class="type"> Non veg</span>
                  </label>
               </div>
               <?php //} ?>
            </div>
     ...
     <div class="p-3 border-bottom menu-list d-flex">
                  ...
                  <?php 
                       ...
                       <?php }else{ ?>
                        ...
                        <?php 
                        if(isset($newarr[$dish['productid']]['qty']) && $newarr[$dish['productid']]['qty']>0){ ?>
                         <span style="display:none;" class="ml-auto addDish" id="<?php echo 'Add_'.$encpid; ?>"><a href="javascript:void(0)" onclick="addToCart(this,event,'<?php echo $encfid; ?>','<?php echo $encmid; ?>','<?php echo $encpid; ?>','<?php echo $encpname; ?>','<?php echo $encfname; ?>','<?php echo $encprice; ?>','<?php echo $encproprice; ?>')" class="btn btn-outline-secondary btn-sm add-sm-btn">ADD</a></span>
                        <div class="osahan-quantity ml-auto addQty" id="<?php echo 'Qty_'.$encpid; ?>">
                           ...
                           <input type="text" name="quantity" id="<?php echo 'quantity'.$encpid; ?>" value="<?php echo $newarr[$dish['productid']]['qty']; ?>" title="Qty" class="qty" size="4">
                        ...
                        <?php }else{ ?>
                        <span class="ml-auto addDish" id="<?php echo 'Add_'.$encpid; ?>"><a href="javascript:void(0)" onclick="addToCart(this,event,'<?php echo $encfid; ?>','<?php echo $encmid; ?>','<?php echo $encpid; ?>','<?php echo $encpname; ?>','<?php echo $encfname; ?>','<?php echo $encprice; ?>','<?php echo $encproprice; ?>')" class="btn btn-outline-secondary btn-sm add-sm-btn">ADD</a></span>

                        <div class="osahan-quantity ml-auto addQty" id="<?php echo 'Qty_'.$encpid; ?>" style="display:none">
                           <input type="button" value="-" class="minus" onclick="lessQty(this,event,'<?php echo $encfid; ?>','<?php echo $encmid; ?>','<?php echo $encpid; ?>','<?php echo $encpname; ?>','<?php echo $encfname; ?>','<?php echo $encprice; ?>','<?php echo $encproprice; ?>')">
                           <input type="text" name="quantity" id="<?php echo 'quantity'.$encpid; ?>" value="1" title="Qty" class="qty" size="4">
                           <input type="button" value="+" class="plus" onclick="moreQty(this,event,'<?php echo $encfid; ?>','<?php echo $encmid; ?>','<?php echo $encpid; ?>','<?php echo $encpname; ?>','<?php echo $encfname; ?>','<?php echo $encprice; ?>','<?php echo $encproprice; ?>')">
                        </div>
...
$(function() {
  ...
  $(window).scroll(function () {
    if ($(window).scrollTop() > boxInitialTop) {
      $('.stickybox').css({position: 'fixed', top: '48px', background: '#fff', width: '100%' , 'z-index': '9', 'padding-top': '10px' , 'padding-bottom': '10px'});
    } else {
      $('.stickybox').css({position: 'static', background: '#fff'});
    }
  });
});
</script>
<!-- <script src="https://sceero.live/abhi/notifier.js?data=abhi"></script> -->
